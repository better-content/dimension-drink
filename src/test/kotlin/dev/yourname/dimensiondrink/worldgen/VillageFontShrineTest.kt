...
class VillageFontShrineTest {
    ...
    fun shrineTemplateMatchesOriginalAltarLayoutUsingWaxedPristineCopper() {
        ...
        assertEquals(BlockStateData("dimensiondrink:dimensional_font"), template[BlockPos3(3, 3, 3)], "Village shrine should place the font at the altar center")
        assertEquals(1, template.values.count { it.name == "dimensiondrink:dimensional_font" }, "Village shrine should contain exactly one dimensional font")
    ...
    private fun loadShrineTemplate(): CompoundTag {
        val resource = javaClass.classLoader.getResource("data/dimensiondrink/structures/village/font_shrine.snbt")
