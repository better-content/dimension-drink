...
class ObeliskCommandGameTests {
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_commands_spawn", timeoutTicks = 500)
    ...
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_commands", timeoutTicks = 500)
    ...
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_commands", timeoutTicks = 800)
