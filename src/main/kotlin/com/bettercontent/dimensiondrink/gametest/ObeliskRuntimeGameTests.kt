...
class ObeliskRuntimeGameTests {
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_runtime_runtime_service_lists_and_finds_loaded_dimension_drink", timeoutTicks = 220)
    ...
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_runtime_terrain_clearing_task_is_removed", timeoutTicks = 120)
    fun terrain_clearing_task_is_removed(helper: GameTestHelper) {
        ObeliskGameTestSupport.terrainClearingTaskIsRemoved(helper)
    }

    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_runtime_font_regen_ignores_altar_copper_oxidation", timeoutTicks = 120)
    ...
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_runtime_font_charges_while_loaded_and_catches_up_after_unload", timeoutTicks = 160)
    ...
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_runtime_font_regeneration_clock_handles_clean_active_and_future_state", timeoutTicks = 120)
    ...
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_runtime_font_axe_scrapes_altar_copper_oxidation", timeoutTicks = 120)
    ...
    @GameTest(templateNamespace = "dimension_drink", template = "bootstrap/empty", batch = "obelisk_runtime_font_passively_renews_nearby_copper_oxidation", timeoutTicks = 260)
