...
object ObeliskDataManager {
    ...
    fun allDimensionDrinks(): Collection<ObeliskDefinition> {
        ensureLoaded()
    ...
    fun enabledDimensionDrinks(): List<ObeliskDefinition> {
        ensureLoaded()
    ...
    private fun normalizeObeliskDefinition(definition: ObeliskDefinition): ObeliskDefinition? {
        ...
        return definition.copy(
            ...
            dimensionDrinkCoreBlock = stringOrNull(definition.dimensionDrinkCoreBlock),
            dimensionDrinkShellBlock = stringOrNull(definition.dimensionDrinkShellBlock),
