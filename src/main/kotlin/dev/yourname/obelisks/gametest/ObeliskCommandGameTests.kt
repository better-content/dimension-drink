...
class ObeliskCommandGameTests {
    @GameTest(templateNamespace = "dimensionalfonts", template = "bootstrap/empty", batch = "obelisk_commands_spawn", timeoutTicks = 500)
    ...
    @GameTest(templateNamespace = "dimensionalfonts", template = "bootstrap/empty", batch = "obelisk_commands", timeoutTicks = 500)
    ...
    @GameTest(templateNamespace = "dimensionalfonts", template = "bootstrap/empty", batch = "obelisk_commands", timeoutTicks = 800)
