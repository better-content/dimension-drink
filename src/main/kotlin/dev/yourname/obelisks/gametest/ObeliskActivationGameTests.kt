...
class ObeliskActivationGameTests {
    @GameTest(templateNamespace = "obelisks", template = "bootstrap/empty", batch = "obelisk_activation_player", timeoutTicks = 3600)
    ...
    @GameTest(templateNamespace = "obelisks", template = "bootstrap/empty", batch = "obelisk_activation_relocated", timeoutTicks = 3600)
