...
import dev.yourname.dimensiondrink.worldgen.pickCourtPotBlock
...
class ObeliskDataGameTests {
    @GameTest(templateNamespace = "dimensiondrink", template = "bootstrap/empty", batch = "obelisk_data", timeoutTicks = 200)
    ...
    @GameTest(templateNamespace = "dimensiondrink", template = "bootstrap/empty", batch = "obelisk_data", timeoutTicks = 400)
    ...
    @GameTest(templateNamespace = "dimensiondrink", template = "bootstrap/empty", batch = "obelisk_data_worldgen", timeoutTicks = 200)
    ...
    @GameTest(templateNamespace = "dimensiondrink", template = "bootstrap/empty", batch = "obelisk_data_structure_piece", timeoutTicks = 500)
    ...
    @GameTest(templateNamespace = "dimensiondrink", template = "bootstrap/empty", batch = "obelisk_data", timeoutTicks = 120)
