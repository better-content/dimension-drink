...
class ObeliskVoidGameTests {
    @GameTest(templateNamespace = "dimensiondrink", template = "bootstrap/empty", batch = "obelisk_void", timeoutTicks = 700)
    ...
    @GameTest(templateNamespace = "dimensiondrink", template = "bootstrap/empty", batch = "obelisk_void_nether", timeoutTicks = 700)
