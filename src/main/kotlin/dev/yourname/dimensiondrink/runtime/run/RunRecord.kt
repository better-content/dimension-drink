...
data class RunRecord(
    ...
    var backendSiteBounds: dev.yourname.dimensiondrink.runtime.backend.SiteBounds? = null,
    ...
    companion object {
        ...
        private fun encodeBounds(bounds: dev.yourname.dimensiondrink.runtime.backend.SiteBounds): CompoundTag = CompoundTag().apply {
        ...
        private fun decodeBounds(tag: CompoundTag): dev.yourname.dimensiondrink.runtime.backend.SiteBounds {
            return dev.yourname.dimensiondrink.runtime.backend.SiteBounds(
